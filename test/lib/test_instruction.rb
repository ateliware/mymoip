...
class TestInstruction < Test::Unit::TestCase
  def test_getters_for_attributes
    payer       = MyMoip::Fixture.payer
    commissions = [MyMoip::Fixture.commission]
  ...
  def test_should_generate_a_string_when_converting_to_xml
    payer       = MyMoip::Fixture.payer
    instruction = MyMoip::Fixture.instruction(payer: payer)
...
XML
  ...
  def test_xml_format_with_installments
    ...
    instruction  = MyMoip::Fixture.instruction(payer: payer, installments: installments)
...
XML
  ...
  def test_xml_format_with_commissions
    commissions = [MyMoip::Fixture.commission(fixed_value: 5), MyMoip::Fixture.commission(percentage_value: 0.15, fixed_value: nil)]
    payer       = MyMoip::Fixture.payer
    instruction = MyMoip::Fixture.instruction(payer: payer, commissions: commissions, installments: nil)
    expected_format = <<XML
...
XML
  ...
  def test_xml_format_with_commissions_and_fee_payer
    commissions = [MyMoip::Fixture.commission(fixed_value: 5), MyMoip::Fixture.commission(percentage_value: 0.15,fixed_value: nil)]
    payer       = MyMoip::Fixture.payer
    instruction = MyMoip::Fixture.instruction(payer: payer, commissions: commissions, fee_payer_login: 'fee_payer_indentifier', installments: nil)
    expected_format = <<XML
...
XML
  ...
  def test_xml_format_with_commissions_and_payment_receiver
    commissions = [MyMoip::Fixture.commission(fixed_value: 5), MyMoip::Fixture.commission(percentage_value: 0.15, fixed_value: nil)]
    payer       = MyMoip::Fixture.payer
    instruction = MyMoip::Fixture.instruction(payer: payer, commissions: commissions,
...
XML
  ...
  def test_to_xml_method_raises_exception_when_called_with_some_invalid_comission
    invalid_commission = MyMoip::Fixture.commission
    invalid_commission.stubs(:invalid?).returns(true)
    subject = MyMoip::Fixture.instruction(commissions: [MyMoip::Fixture.commission, invalid_commission])
  ...
  def test_to_xml_method_raises_exception_when_called_with_invalid_payer
    subject = MyMoip::Fixture.instruction
  ...
  def test_validate_no_presence_of_payment_receiver_in_commissions
    commissions = [MyMoip::Fixture.commission(receiver_login: 'payment_receiver_id')]
    subject = MyMoip::Fixture.instruction(payment_receiver_login: 'payment_receiver_id', commissions: commissions)
  ...
  def test_gross_amount
    subject = MyMoip::Fixture.instruction(values: [6, 5])
    assert_equal 11, subject.gross_amount
  end

  def test_commissions_sum
    commissions = [MyMoip::Fixture.commission(fixed_value: 5), MyMoip::Fixture.commission(percentage_value: 0.1, fixed_value: nil)]
    subject = MyMoip::Fixture.instruction(commissions: commissions, values: [10])
    assert_equal 6, subject.commissions_sum
  end

  def test_validate_commissions_sum
    commissions = [MyMoip::Fixture.commission(fixed_value: 5), MyMoip::Fixture.commission(fixed_value: 5)]
    subject = MyMoip::Fixture.instruction(commissions: commissions, values: [6])
